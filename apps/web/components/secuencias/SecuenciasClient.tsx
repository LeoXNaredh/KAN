 ...
 * JSON libre como en AutomatizacionesClient, es justo lo que pide esta
 * pantalla: number/integer → input numérico, boolean → checkbox, string con
 * enum → select, string sin enum → texto.
 */
function ParamField({
  fieldKey,
  schema,
