...
export const SECONDARY_BUTTON_CLASSES =
  "glass rounded-xl border border-line/80 px-4 py-2 text-sm font-medium text-ink-muted transition-all duration-fast hover:border-accent/40 hover:text-ink focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent";
